-- Ozone Staking Database Setup Script
-- Run this in PHPMyAdmin or MySQL command line

-- Drop database if exists (be careful in production!)
DROP DATABASE IF EXISTS ozone_staking;

-- Create database with proper charset
CREATE DATABASE ozone_staking CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
